 ...
 * @param {Object} params - Paramètres de l'URL contenant le slug de la recette.
 */
export default function RecipePage({ params }) {

  const { slug } = use(params)

  /** @type {Object} Recherche la recette correspondant au slug */
  ...
  return (
    ...
    <div className="min-h-screen w-full max-w-360 mx-auto flex flex-col">
      <HeaderRecipe />
